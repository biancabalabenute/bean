...
const Modal = ({ isOpen, onClose, children }) => {
  ...
  return (
    <div style={{width:'901px', marginLeft:'-1px'}} className="modal-overlay">
      <div className="modal">
...
const App = () => {
  ...
  return (
    <div>
      ...
      <h2 id ="tituloCadastrar" style={{marginTop: '20px'}} onClick={openModal}>Cadastrar Cliente</h2>
      <i  id = "iconCadastrar" className="fa-solid fa-user-circle" style={{fontSize: 30, }}></i>
    
      <Modal isOpen={modalIsOpen} onClose={closeModal}>
      <h1 style={{paddingTop:'40px', paddingLeft: '20px'}} >Cadastrar Cliente </h1>
        
        <CadastrarCliente/>
        <div class="buton0">
        <button onClick={closeModal} id= "butonCancelar" type="submit">Cancelar</button>
        <button  id='butonLimpar'>Limpar</button>
        </div>
        <div class="buton2">
